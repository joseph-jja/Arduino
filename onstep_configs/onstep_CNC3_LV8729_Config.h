...
// Slewing Speed: 1.76 degrees/second (estimated)
// Generated on: 2023-08-27 11:45
// ---------------------------------------------------------------------------------------------------------------------------------
...
#define SERIAL_GPS_RX 32
#define SERIAL_GPS_TX 33    
...
#define SLEW_RATE_BASE_DESIRED        10 //    1.0, n. Desired slew rate in deg/sec. Adjustable at run-time from            <-Req'd
...
#define AXIS1_STEPS_PER_DEGREE    32000.00 //  12800, n. Number of steps per degree:                                          <-Req'd
...
#define AXIS1_HOME_DEFAULT 90             // 90 should be east

// AXIS2 DEC/ALT
// see https://onstep.groups.io/g/main/wiki/6-Configuration
#define AXIS2_STEPS_PER_DEGREE    22222.22 //  12800, n. Number of steps per degree:                                          <-Req'd
                                          //         n = (stepper_steps * micro_steps * overall_gear_reduction)/360.0
...
#define AXIS2_LIMIT_MIN               -10 //    -90, n. Where n=-90..0 (degrees.) Minimum allowed declination.                Infreq
#define AXIS2_LIMIT_MAX                90 //     90, n. Where n=0..90 (degrees.) Maximum allowed declination.                 Infreq

#define AXIS2_HOME_DEFAULT 85             // dec 90 should be straight up
