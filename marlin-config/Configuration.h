...
#define STRING_CONFIG_H_AUTHOR "(Joe, Ender-3)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender-3 4.2.7 20260402"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 424.19 }
